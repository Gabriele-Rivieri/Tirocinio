...
function exp_HeatMap_Popolaz_Residente_MF_95rule0_eval_expression(context) {
    // Popolazione_Residente_TOTM > Popolazione_Residente_TOTF

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('Popolazione_Residente_TOTM')  > feature.get('Popolazione_Residente_TOTF') );
    } else {
        return (feature.get('Popolazione_Residente_TOTM')  > feature.get('Popolazione_Residente_TOTF') );
    }
}
...
function exp_HeatMap_Popolaz_Residente_MF_95rule1_eval_expression(context) {
    // Popolazione_Residente_TOTF > Popolazione_Residente_TOTM

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('Popolazione_Residente_TOTF')  > feature.get('Popolazione_Residente_TOTM') );
    } else {
        return (feature.get('Popolazione_Residente_TOTF')  > feature.get('Popolazione_Residente_TOTM') );
    }
}