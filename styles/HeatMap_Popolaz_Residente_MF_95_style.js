...
var style_HeatMap_Popolaz_Residente_MF_95 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    if (feature.get("COMUNE") !== null) {
        ...
        function rules_HeatMap_Popolaz_Residente_MF_95(feature, value) {
            var context = {
                feature: feature,
                variables: {}
            };
            // Start of if blocks and style check logic
            if (exp_HeatMap_Popolaz_Residente_MF_95rule0_eval_expression(context)) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    else if (exp_HeatMap_Popolaz_Residente_MF_95rule1_eval_expression(context)) {
                      return [ new ol.style.Style({
        ...
        var style = rules_HeatMap_Popolaz_Residente_MF_95(feature, value);
        ;
